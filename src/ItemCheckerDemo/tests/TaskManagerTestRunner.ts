import { TaskSchema, TaskManagerInterface } from '../../types';
...
export function runTaskManagerTests(createTaskManager: (name: string) => TaskManagerInterface) {
    describe('Implementation Of Interface', () => {

        /**
         * Test to ensure that adding a task works correctly
         */
        test('add task should add a task to the database', () => {
            const listManager = createTaskManager('test_db_1.db');
        ...
        test('addTask should return 409 if task already exists', () => {
            const listManager = createTaskManager('test_db_3.db');
        ...
        test('addComment should add a comment to a task', () => {
            const listManager = createTaskManager('test_db_4.db');
            const mockTask: TaskSchema = {
                taskName: 'task2',
                approver1: 'user1',
                approver2: 'user2',
        ...
        test('addComment should add comments to a task with multiple approvers', () => {
            const listManager = createTaskManager('test_db_5.db');
            const mockTask: TaskSchema = {
                taskName: 'task3',
                approver1: 'user1',
                approver2: 'user2',
        ...
        test('addComment should return 404 if task does not exist', () => {
            const listManager = createTaskManager('test_db_6.db');
            const comment = 'This is a comment';
            const user = 'user1';
        ...
        test('addComment should return 401 if user is not an approver', () => {
            const listManager = createTaskManager('test_db_7.db');
            const mockTask: TaskSchema = {
                taskName: 'task4',
                approver1: 'user1',
                approver2: 'user2',
        ...
        test('getTask should return 404 if task does not exist', () => {
            const listManager = createTaskManager('test_db_8.db');
        ...
        test('getAllTasks should return all tasks', () => {
            const listManager = createTaskManager('test_db_9.db');
        ...
        test('addRecommendation should add a recommendation to a task', () => {
            const listManager = createTaskManager('test_db_10.db');
            const mockTask: TaskSchema = {
                taskName: 'task5',
                approver1: 'user1',
                approver2: 'user2',
        ...
        test('addRecommendation should return 404 if task does not exist', () => {
            const listManager = createTaskManager('test_db_11.db');
            const recommendation = 'This is a recommendation';
            const user = 'user1';
        ...
        test('addRecommendation should return 401 if user is not an approver', () => {
            const listManager = createTaskManager('test_db_12.db');
            const mockTask: TaskSchema = {
                taskName: 'task7',
                approver1: 'user1',
                approver2: 'user2',
        ...
        test('clearComments should clear comments for a task', () => {
            const listManager = createTaskManager('test_db_13.db');
            const mockTask: TaskSchema = {
                taskName: 'task8',
                approver1: 'user1',
                approver2: 'user2',
        ...
        test('clearComments should return 404 if task does not exist', () => {
            const listManager = createTaskManager('test_db_14.db');
            const user = 'user1';
        ...
        test('clearComments should return 401 if user is not an approver', () => {
            const listManager = createTaskManager('test_db_15.db');
            const mockTask: TaskSchema = {
                taskName: 'task10',
                approver1: 'user1',
                approver2: 'user2',
